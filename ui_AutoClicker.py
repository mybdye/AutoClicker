...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        Dialog.resize(190, 220)
        Dialog.setMinimumSize(QtCore.QSize(190, 220))
        Dialog.setMaximumSize(QtCore.QSize(190, 220))
        self.groupBox = QtWidgets.QGroupBox(Dialog)
        self.groupBox.setGeometry(QtCore.QRect(10, 0, 171, 141))
        self.groupBox.setObjectName("groupBox")
        self.lineEdit_counter = QtWidgets.QLineEdit(self.groupBox)
        self.lineEdit_counter.setGeometry(QtCore.QRect(60, 30, 100, 20))
        ...
        self.lineEdit_waitFirstTime.setGeometry(QtCore.QRect(120, 90, 40, 20))
        ...
        self.progressBar_left.setGeometry(QtCore.QRect(60, 46, 100, 10))
        ...
        self.pushButton_save.setGeometry(QtCore.QRect(0, 110, 80, 30))
        self.pushButton_save.setObjectName("pushButton_save")
        self.pushButton_pause = QtWidgets.QPushButton(Dialog)
        self.pushButton_pause.setGeometry(QtCore.QRect(130, 110, 50, 30))
        self.pushButton_pause.setObjectName("pushButton_pause")
        self.pushButton_start = QtWidgets.QPushButton(Dialog)
        self.pushButton_start.setGeometry(QtCore.QRect(85, 110, 50, 30))
        self.pushButton_start.setObjectName("pushButton_start")
        self.textBrowser = QtWidgets.QTextBrowser(Dialog)
        self.textBrowser.setGeometry(QtCore.QRect(9, 150, 171, 61))
